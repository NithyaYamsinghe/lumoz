...
class _UpdateReminderScreenState extends State<UpdateReminderScreen> {
  ...
  Widget build(BuildContext context) {
    _tvShowNameController = TextEditingController(text: widget.reminder.tvShow);
            ...
            child: Column(children: [
              ...
              Row(
                ...
                children: [
                  _colorPalette(),
                  MainButton(
                      label: "Update Reminder", onTap: () => _validateFormData())
                ],
              )
            ])),
      ),
  ...
  _saveFormDataToDB() async {
    _reminderController.updateReminderRecord(Reminder(
