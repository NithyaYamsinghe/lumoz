...
class _AddReminderScreenState extends State<AddReminderScreen> {
            ...
            child: Column(
              children:[
                ...
                Row(
                  ...
                  children: [
                   _colorPalette(),
                    MainButton(label: "Add Reminder", onTap: ()=>_validateFormData())
                  ],
                )
            ]
            )
  ...
  _validateFormData(){
    if(_tvShowNameController.text.isNotEmpty && _noteController.text.isNotEmpty){

      _saveFormDataToDB();
      Get.back();

    }else if(
    _tvShowNameController.text.isEmpty && _noteController.text.isEmpty
    ) {
                  ...
                  return GestureDetector(
                    ...
                    child:Padding(
                      ...
                      child: CircleAvatar(
                        ...
                        child: _selectedColor==index?const Icon(Icons.done, color: Colors.white,
                          size: 16,): Container(),
